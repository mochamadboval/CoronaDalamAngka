    ...
    <div class="row">
      ...
      <div class="col-lg mb-2 mb-lg-0">
        ...
        <p class="d-flex">
          ...
          <span>
            <strong class="text-warning"><fa-icon icon="angle-up" /> {{ confirmed.new }}</strong> 
            {{ confirmed.total }}
          </span>
        </p>
        <hr>
        <p class="d-flex">
          ...
          <span>
            <strong class="text-success"><fa-icon icon="angle-up" /> {{ recovered.new }}</strong> 
            {{ recovered.total }}
          </span>
        </p>
        <hr>
        <p class="d-flex">
          ...
          <span>
            <strong class="text-danger"><fa-icon icon="angle-up" /> {{ deaths.new }}</strong> 
           {{ deaths.total }}
          </span>
        </p>
        <hr>
      ...
      <div class="col-md mb-2 mb-lg-0">
        ...
        <p class="d-flex">
          <span class="me-auto">
            <strong class="text-primary"><fa-icon icon="mars" /></strong> {{ gender.male }}
          </span>
          <span>
            {{ gender.female }} <strong class="text-danger"><fa-icon icon="venus" /></strong>
          </span>
        </p>
      </div>
      <!-- Age -->
...
export default {
  ...
  methods: {
    getProvince() {
      const provinceSelected = document.getElementById('Provinces').selectedOptions[0].text;
